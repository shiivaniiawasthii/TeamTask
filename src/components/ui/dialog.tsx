...
>(({ className, children, side = "center", ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        side === "right"
          ? "fixed inset-y-0 right-0 z-50 w-full max-w-lg border-l bg-background p-6 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right overflow-y-auto"
